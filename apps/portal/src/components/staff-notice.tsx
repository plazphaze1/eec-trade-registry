const notices: Record<string, string> = {
  ...
  dealer_created: "The business and its trading authority were created together.",
  dealer_status_changed: "The business authority decision was recorded.",
  dealer_updated: "The business identity and authority details were saved.",
