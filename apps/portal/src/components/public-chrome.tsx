...
export function PublicHeader({ institutionName }: { institutionName: string }) {
  ...
  return <header className="site-header"><div className="site-header-inner">
    <Link className="brand" href="/" aria-label={`${institutionName} home`}><span className="brand-mark" aria-hidden="true">EEC</span><span><strong>{institutionName}</strong><small>Trade &amp; supply</small></span></Link>
