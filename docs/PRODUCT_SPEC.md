...
9. **Keystone reserves come from production.** The initial baseline is Iron Ore, Firewood, Iron Ingot, Corundum Ore, Corundum Ingot, Steel Ingot, Leather, and Leather Strips. These materials enter Company stock through recorded purchases, not administrative spawning. Routine aggregate buys may omit seller identity; named supplier deliveries remain available when counterparty evidence matters. Guaranteed purchase floors and high reserve resale terms form an economic corridor without replacing player trade.
...
11. **The interface is smaller than the domain.** Ordinary staff describe the buyer, goods, quantity, and handoff; Supabase derives classifications and carries references. Specialist systems appear on the records to which they apply or through task search. Only cross-system Owner administration appears on Today, and it never competes with primary navigation.
